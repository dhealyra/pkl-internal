...
<body>
  <!-- Preloader -->
  <div class="preloader">
    <img src="{{ ('assets/backend/images/logos/favicon.png') }}" alt="loader" class="lds-ripple img-fluid" />
  </div>
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input  id="exampleInputtext" aria-describedby="textHelp" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input  id="exampleInputEmail1" aria-describedby="emailHelp" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
